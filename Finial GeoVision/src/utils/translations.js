export const getTranslations = (lang = 'en') => ({
  ...
  collections: lang === 'ar' ? 'المفضلة' : 'Favorites',
  savedQueries: lang === 'ar' ? 'الاستعلامات المثبتة' : 'Pinned Queries',
  pinned: lang === 'ar' ? 'المثبتة' : 'Pinned',
  pinnedQueries: lang === 'ar' ? 'الاستعلامات المثبتة' : 'Pinned Queries',
  recents: lang === 'ar' ? 'الأخيرة' : 'Recents',
  chatSessions: lang === 'ar' ? 'جلسات المحادثة' : 'Chat Sessions',
  newChat: lang === 'ar' ? 'محادثة جديدة' : 'New Chat',
  deleteSession: lang === 'ar' ? 'حذف الجلسة' : 'Delete Session',
  sessionRenamed: lang === 'ar' ? 'تمت إعادة تسمية الجلسة' : 'Session renamed',
  noChatSessions: lang === 'ar' ? 'لا توجد جلسات محادثة سابقة' : 'No chat sessions yet',
  pinQuery: lang === 'ar' ? 'تثبيت الاستعلام' : 'Pin Query',
  unpinQuery: lang === 'ar' ? 'إلغاء التثبيت' : 'Unpin Query',
  favorites: lang === 'ar' ? 'المفضلة' : 'Favorites',
  shareFeedback: lang === 'ar' ? 'ملاحظاتك وتقييمك' : 'Share Feedback',
  feedbackTitle: lang === 'ar' ? 'شاركنا ملاحظاتك' : 'Share Your Feedback',
  feedbackSubtitle: lang === 'ar' ? 'قيّم تجربتك وشاركنا ملاحظاتك واقتراحاتك.' : 'Rate Your Experience And Share Your Feedback.',
  feedbackName: lang === 'ar' ? 'الاسم' : 'Name',
  feedbackNamePlaceholder: lang === 'ar' ? 'أدخل اسمك' : 'Enter your name',
  feedbackEmail: lang === 'ar' ? 'البريد الإلكتروني' : 'Email',
  feedbackEmailPlaceholder: lang === 'ar' ? 'أدخل بريدك الإلكتروني' : 'Enter your email address',
  feedbackMessage: lang === 'ar' ? 'الرسالة' : 'Message',
  feedbackMessagePlaceholder: lang === 'ar' ? 'شاركنا ملاحظاتك أو اقتراحاتك...' : 'Share your feedback or suggestions...',
  feedbackSubmit: lang === 'ar' ? 'إرسال' : 'Submit',
  feedbackCancel: lang === 'ar' ? 'إلغاء' : 'Cancel',
  feedbackSuccess: lang === 'ar' ? 'شكراً لك! تم استلام ملاحظاتك بنجاح.' : 'Thank you! Your feedback has been received successfully.',
  ...
  recentSearches: lang === 'ar' ? 'الأخيرة' : 'Recents',
  clearAll: lang === 'ar' ? 'مسح الكل' : 'Clear All',
  filterHistoryPlaceholder: lang === 'ar' ? 'البحث في السجل...' : 'Search history...',
  ...
  editQuery: lang === 'ar' ? 'تعديل الاستعلام' : 'Edit Query',
  edit: lang === 'ar' ? 'تعديل' : 'Edit',
  cancel: lang === 'ar' ? 'إلغاء' : 'Cancel',
  editingQueryPlaceholder: lang === 'ar' ? 'تعديل نص الاستعلام...' : 'Edit search query...',
  ...
  quickSuggestions: lang === 'ar' ? 'اقتراحات سريعة' : 'Quick Suggestions',
  ...
  route: lang === 'ar' ? 'المسار' : 'Route',
  getDirections: lang === 'ar' ? 'الحصول على الاتجاهات' : 'Get Directions',
  fromMyLocation: lang === 'ar' ? 'موقعي الحالي' : 'My Current Location',
  destination: lang === 'ar' ? 'الوجهة' : 'Destination',
  distance: lang === 'ar' ? 'المسافة' : 'Distance',
  estimatedTravelTime: lang === 'ar' ? 'الوقت التقديري' : 'Est. Travel Time',
  travelMode: lang === 'ar' ? 'وسيلة التنقل' : 'Travel Mode',
  walk: lang === 'ar' ? 'مشي' : 'Walk',
  cycle: lang === 'ar' ? 'دراجة هوائية' : 'Cycle',
  bike: lang === 'ar' ? 'دراجة نارية' : 'Bike',
  publicTransport: lang === 'ar' ? 'نقل عام' : 'Public Transport',
  ...
  of: lang === 'ar' ? 'من' : 'of',
  inAppNavigation: lang === 'ar' ? 'الملاحة المباشرة' : 'Live Navigation',
  calculatingRoute: lang === 'ar' ? 'جاري حساب المسار المباشر...' : 'Calculating road route...',
  modeUnavailable: lang === 'ar' ? 'غير متوفر في هذا النطاق' : 'Unavailable in this area',
  closeRoute: lang === 'ar' ? 'إغلاق المسار' : 'Close Route',
  swapDirection: lang === 'ar' ? 'عكس الاتجاه' : 'Swap Direction',
  locationRequiredForRoute: lang === 'ar' ? 'مطلوب إذن الموقع لحساب مسار الطريق بدقة من موقعك الحالي.' : 'Location permission is required to calculate road directions from your current location.',
  detectMyLocation: lang === 'ar' ? 'تحديد موقعي الآن' : 'Detect My Location',
  openInExternalMaps: lang === 'ar' ? 'فتح في خرائط الملاحة' : 'Open in Maps Navigation',
